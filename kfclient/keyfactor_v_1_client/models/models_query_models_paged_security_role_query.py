...
from ..models.models_query_models_paged_security_role_query_sort_ascending import (
    ModelsQueryModelsPagedSecurityRoleQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedSecurityRoleQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedSecurityRoleQuery:
    """Paged query for security identities.

    Attributes:
        validate (Union[Unset, bool]): Whether to audit the signed xml for every role requested by the query
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedSecurityRoleQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedSecurityRoleQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedSecurityRoleQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedSecurityRoleQuerySortAscending(_sort_ascending)

        models_query_models_paged_security_role_query = cls(
            validate=validate,
        ...
        models_query_models_paged_security_role_query.additional_properties = d
        return models_query_models_paged_security_role_query
