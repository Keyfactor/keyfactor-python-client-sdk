...
from ..models.models_query_models_paged_security_identity_query_sort_ascending import (
    ModelsQueryModelsPagedSecurityIdentityQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedSecurityIdentityQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedSecurityIdentityQuery:
    """Paged query for security identities.

    Attributes:
        validate (Union[Unset, bool]): Whether to audit the signed xml for every identity requested by the query
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedSecurityIdentityQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedSecurityIdentityQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedSecurityIdentityQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedSecurityIdentityQuerySortAscending(_sort_ascending)

        models_query_models_paged_security_identity_query = cls(
            validate=validate,
        ...
        models_query_models_paged_security_identity_query.additional_properties = d
        return models_query_models_paged_security_identity_query
