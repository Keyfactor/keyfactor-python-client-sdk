...
from ..models.models_query_models_paged_agent_blueprint_stores_query_sort_ascending import (
    ModelsQueryModelsPagedAgentBlueprintStoresQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedAgentBlueprintStoresQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedAgentBlueprintStoresQuery:
    """
    Attributes:
        ...
        sort_field (Union[Unset, str]): Field by which the results should be sorted (OperationStart, OperationEnd,
            UserName)
        sort_ascending (Union[Unset, ModelsQueryModelsPagedAgentBlueprintStoresQuerySortAscending]): Field sort
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentBlueprintStoresQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentBlueprintStoresQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedAgentBlueprintStoresQuerySortAscending(_sort_ascending)

        models_query_models_paged_agent_blueprint_stores_query = cls(
        ...
        models_query_models_paged_agent_blueprint_stores_query.additional_properties = d
        return models_query_models_paged_agent_blueprint_stores_query
