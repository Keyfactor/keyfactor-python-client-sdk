...
T = TypeVar("T", bound="KeyfactorApiModelsAlertsDeniedDeniedAlertDefinitionResponse")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsAlertsDeniedDeniedAlertDefinitionResponse:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_alerts_denied_denied_alert_definition_response = cls(
            id=id,
        ...
        keyfactor_api_models_alerts_denied_denied_alert_definition_response.additional_properties = d
        return keyfactor_api_models_alerts_denied_denied_alert_definition_response
