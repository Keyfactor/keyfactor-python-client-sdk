...
T = TypeVar("T", bound="KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertCreationRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertCreationRequest:
    """
    Attributes:
        display_name (str):
        subject (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_alerts_key_rotation_key_rotation_alert_creation_request = cls(
        ...
        keyfactor_api_models_alerts_key_rotation_key_rotation_alert_creation_request.additional_properties = d
        return keyfactor_api_models_alerts_key_rotation_key_rotation_alert_creation_request
