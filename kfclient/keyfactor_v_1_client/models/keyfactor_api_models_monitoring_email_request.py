...
T = TypeVar("T", bound="KeyfactorApiModelsMonitoringEmailRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsMonitoringEmailRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_monitoring_email_request = cls(
            enable_reminder=enable_reminder,
            warning_days=warning_days,
            recipients=recipients,
        )

        keyfactor_api_models_monitoring_email_request.additional_properties = d
        return keyfactor_api_models_monitoring_email_request
