...
from ..models.models_query_models_paged_expiration_alert_query_sort_ascending import (
    ModelsQueryModelsPagedExpirationAlertQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedExpirationAlertQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedExpirationAlertQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedExpirationAlertQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedExpirationAlertQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedExpirationAlertQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedExpirationAlertQuerySortAscending(_sort_ascending)

        models_query_models_paged_expiration_alert_query = cls(
        ...
        models_query_models_paged_expiration_alert_query.additional_properties = d
        return models_query_models_paged_expiration_alert_query
