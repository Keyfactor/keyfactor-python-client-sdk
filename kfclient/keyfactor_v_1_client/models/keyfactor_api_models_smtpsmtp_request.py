...
T = TypeVar("T", bound="KeyfactorAPIModelsSMTPSMTPRequest")


@attr.s(auto_attribs=True)
class KeyfactorAPIModelsSMTPSMTPRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_smtpsmtp_request = cls(
            host=host,
            id=id,
            port=port,
        ...
        keyfactor_api_models_smtpsmtp_request.additional_properties = d
        return keyfactor_api_models_smtpsmtp_request
