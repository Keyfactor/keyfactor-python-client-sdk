...
from ..models.models_query_models_paged_ssl_result_query_sort_ascending import (
    ModelsQueryModelsPagedSslResultQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedSslResultQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedSslResultQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedSslResultQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedSslResultQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedSslResultQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedSslResultQuerySortAscending(_sort_ascending)

        models_query_models_paged_ssl_result_query = cls(
        ...
        models_query_models_paged_ssl_result_query.additional_properties = d
        return models_query_models_paged_ssl_result_query
