...
T = TypeVar("T", bound="KeyfactorApiModelsMonitoringRevocationMonitoringAlertTestRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsMonitoringRevocationMonitoringAlertTestRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_monitoring_revocation_monitoring_alert_test_request = cls(
            alert_id=alert_id,
            evaluation_date=evaluation_date,
            send_alerts=send_alerts,
        )

        keyfactor_api_models_monitoring_revocation_monitoring_alert_test_request.additional_properties = d
        return keyfactor_api_models_monitoring_revocation_monitoring_alert_test_request
