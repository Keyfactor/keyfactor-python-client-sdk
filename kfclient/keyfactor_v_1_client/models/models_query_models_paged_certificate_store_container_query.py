...
from ..models.models_query_models_paged_certificate_store_container_query_sort_ascending import (
    ModelsQueryModelsPagedCertificateStoreContainerQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedCertificateStoreContainerQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedCertificateStoreContainerQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedCertificateStoreContainerQuerySortAscending]): Field sort
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateStoreContainerQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateStoreContainerQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedCertificateStoreContainerQuerySortAscending(_sort_ascending)

        models_query_models_paged_certificate_store_container_query = cls(
        ...
        models_query_models_paged_certificate_store_container_query.additional_properties = d
        return models_query_models_paged_certificate_store_container_query
