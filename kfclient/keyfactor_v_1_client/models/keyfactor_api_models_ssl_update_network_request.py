...
T = TypeVar("T", bound="KeyfactorApiModelsSslUpdateNetworkRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsSslUpdateNetworkRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_ssl_update_network_request = cls(
        ...
        keyfactor_api_models_ssl_update_network_request.additional_properties = d
        return keyfactor_api_models_ssl_update_network_request
