...
from ..models.models_query_models_paged_key_rotation_alert_query_sort_ascending import (
    ModelsQueryModelsPagedKeyRotationAlertQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedKeyRotationAlertQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedKeyRotationAlertQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedKeyRotationAlertQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedKeyRotationAlertQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedKeyRotationAlertQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedKeyRotationAlertQuerySortAscending(_sort_ascending)

        models_query_models_paged_key_rotation_alert_query = cls(
        ...
        models_query_models_paged_key_rotation_alert_query.additional_properties = d
        return models_query_models_paged_key_rotation_alert_query
