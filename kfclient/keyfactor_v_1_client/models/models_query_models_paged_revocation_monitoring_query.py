...
from ..models.models_query_models_paged_revocation_monitoring_query_sort_ascending import (
    ModelsQueryModelsPagedRevocationMonitoringQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedRevocationMonitoringQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedRevocationMonitoringQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedRevocationMonitoringQuerySortAscending]): Field sort
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedRevocationMonitoringQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedRevocationMonitoringQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedRevocationMonitoringQuerySortAscending(_sort_ascending)

        models_query_models_paged_revocation_monitoring_query = cls(
        ...
        models_query_models_paged_revocation_monitoring_query.additional_properties = d
        return models_query_models_paged_revocation_monitoring_query
