...
from ..models.models_query_models_paged_ssh_unmanaged_key_query_sort_ascending import (
    ModelsQueryModelsPagedSSHUnmanagedKeyQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedSSHUnmanagedKeyQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedSSHUnmanagedKeyQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedSSHUnmanagedKeyQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHUnmanagedKeyQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHUnmanagedKeyQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedSSHUnmanagedKeyQuerySortAscending(_sort_ascending)

        models_query_models_paged_ssh_unmanaged_key_query = cls(
        ...
        models_query_models_paged_ssh_unmanaged_key_query.additional_properties = d
        return models_query_models_paged_ssh_unmanaged_key_query
