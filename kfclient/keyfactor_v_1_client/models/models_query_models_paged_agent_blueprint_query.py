...
from ..models.models_query_models_paged_agent_blueprint_query_sort_ascending import (
    ModelsQueryModelsPagedAgentBlueprintQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedAgentBlueprintQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedAgentBlueprintQuery:
    """
    Attributes:
        ...
        sort_field (Union[Unset, str]): Field by which the results should be sorted (OperationStart, OperationEnd,
            UserName)
        sort_ascending (Union[Unset, ModelsQueryModelsPagedAgentBlueprintQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentBlueprintQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentBlueprintQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedAgentBlueprintQuerySortAscending(_sort_ascending)

        models_query_models_paged_agent_blueprint_query = cls(
        ...
        models_query_models_paged_agent_blueprint_query.additional_properties = d
        return models_query_models_paged_agent_blueprint_query
