...
from ..models.models_query_models_paged_agent_pool_agents_query_sort_ascending import (
    ModelsQueryModelsPagedAgentPoolAgentsQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedAgentPoolAgentsQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedAgentPoolAgentsQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedAgentPoolAgentsQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentPoolAgentsQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentPoolAgentsQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedAgentPoolAgentsQuerySortAscending(_sort_ascending)

        models_query_models_paged_agent_pool_agents_query = cls(
        ...
        models_query_models_paged_agent_pool_agents_query.additional_properties = d
        return models_query_models_paged_agent_pool_agents_query
