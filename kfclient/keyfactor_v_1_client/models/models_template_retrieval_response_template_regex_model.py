...
T = TypeVar("T", bound="ModelsTemplateRetrievalResponseTemplateRegexModel")


@attr.s(auto_attribs=True)
class ModelsTemplateRetrievalResponseTemplateRegexModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        models_template_retrieval_response_template_regex_model = cls(
        ...
        models_template_retrieval_response_template_regex_model.additional_properties = d
        return models_template_retrieval_response_template_regex_model
