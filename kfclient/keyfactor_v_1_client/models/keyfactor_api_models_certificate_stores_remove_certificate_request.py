...
from ..models.models_certificate_location_specifier import ModelsCertificateLocationSpecifier
from ..types import UNSET, Unset

T = TypeVar("T", bound="KeyfactorApiModelsCertificateStoresRemoveCertificateRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsCertificateStoresRemoveCertificateRequest:
    """
    Attributes:
        certificate_stores (List[ModelsCertificateLocationSpecifier]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for certificate_stores_item_data in _certificate_stores:
            certificate_stores_item = ModelsCertificateLocationSpecifier.from_dict(certificate_stores_item_data)
        ...
        keyfactor_api_models_certificate_stores_remove_certificate_request = cls(
            certificate_stores=certificate_stores,
            schedule=schedule,
            collection_id=collection_id,
        )

        keyfactor_api_models_certificate_stores_remove_certificate_request.additional_properties = d
        return keyfactor_api_models_certificate_stores_remove_certificate_request
