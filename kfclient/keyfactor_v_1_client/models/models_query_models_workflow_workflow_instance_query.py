...
from ..models.models_query_models_workflow_workflow_instance_query_sort_ascending import (
    ModelsQueryModelsWorkflowWorkflowInstanceQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsWorkflowWorkflowInstanceQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsWorkflowWorkflowInstanceQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsWorkflowWorkflowInstanceQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsWorkflowWorkflowInstanceQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsWorkflowWorkflowInstanceQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsWorkflowWorkflowInstanceQuerySortAscending(_sort_ascending)

        models_query_models_workflow_workflow_instance_query = cls(
        ...
        models_query_models_workflow_workflow_instance_query.additional_properties = d
        return models_query_models_workflow_workflow_instance_query
