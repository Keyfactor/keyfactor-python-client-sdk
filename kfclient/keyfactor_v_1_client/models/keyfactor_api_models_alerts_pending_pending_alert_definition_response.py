...
from ..models.keyfactor_api_models_alerts_alert_template_alert_template_response import (
...
T = TypeVar("T", bound="KeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsAlertsPendingPendingAlertDefinitionResponse:
    """
    Attributes:
        id (Union[Unset, int]):
        ...
        template (Union[Unset, KeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse]):
    ...
    template: Union[Unset, KeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_template, Unset):
            ...
            template = KeyfactorApiModelsAlertsAlertTemplateAlertTemplateResponse.from_dict(_template)
        ...
        keyfactor_api_models_alerts_pending_pending_alert_definition_response = cls(
            id=id,
        ...
        keyfactor_api_models_alerts_pending_pending_alert_definition_response.additional_properties = d
        return keyfactor_api_models_alerts_pending_pending_alert_definition_response
