...
from ..models.models_query_models_workflow_workflow_step_schema_query_sort_ascending import (
    ModelsQueryModelsWorkflowWorkflowStepSchemaQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsWorkflowWorkflowStepSchemaQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsWorkflowWorkflowStepSchemaQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsWorkflowWorkflowStepSchemaQuerySortAscending]): Field sort
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsWorkflowWorkflowStepSchemaQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsWorkflowWorkflowStepSchemaQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsWorkflowWorkflowStepSchemaQuerySortAscending(_sort_ascending)

        models_query_models_workflow_workflow_step_schema_query = cls(
        ...
        models_query_models_workflow_workflow_step_schema_query.additional_properties = d
        return models_query_models_workflow_workflow_step_schema_query
