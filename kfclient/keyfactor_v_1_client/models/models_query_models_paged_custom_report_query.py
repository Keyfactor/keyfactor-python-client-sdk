...
from ..models.models_query_models_paged_custom_report_query_sort_ascending import (
    ModelsQueryModelsPagedCustomReportQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedCustomReportQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedCustomReportQuery:
    """
    Attributes:
        ammended_query (Union[Unset, str]):
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedCustomReportQuerySortAscending]): Field sort direction
            [0=ascending, 1=descending]
    """

    ammended_query: Union[Unset, str] = UNSET
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedCustomReportQuerySortAscending] = UNSET
    additional_properties: Dict[str, Any] = attr.ib(init=False, factory=dict)

    def to_dict(self) -> Dict[str, Any]:
        ammended_query = self.ammended_query
        ...
        field_dict.update({})
        if ammended_query is not UNSET:
            field_dict["AmmendedQuery"] = ammended_query
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        ammended_query = d.pop("AmmendedQuery", UNSET)
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedCustomReportQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedCustomReportQuerySortAscending(_sort_ascending)

        models_query_models_paged_custom_report_query = cls(
            ammended_query=ammended_query,
        ...
        models_query_models_paged_custom_report_query.additional_properties = d
        return models_query_models_paged_custom_report_query
