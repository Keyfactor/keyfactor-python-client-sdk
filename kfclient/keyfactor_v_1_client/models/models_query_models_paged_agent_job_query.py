...
from ..models.models_query_models_paged_agent_job_query_sort_ascending import (
    ModelsQueryModelsPagedAgentJobQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedAgentJobQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedAgentJobQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedAgentJobQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentJobQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentJobQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedAgentJobQuerySortAscending(_sort_ascending)

        models_query_models_paged_agent_job_query = cls(
        ...
        models_query_models_paged_agent_job_query.additional_properties = d
        return models_query_models_paged_agent_job_query
