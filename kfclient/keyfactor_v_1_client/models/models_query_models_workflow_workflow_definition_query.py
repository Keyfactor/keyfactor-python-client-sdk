...
from ..models.models_query_models_workflow_workflow_definition_query_sort_ascending import (
    ModelsQueryModelsWorkflowWorkflowDefinitionQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsWorkflowWorkflowDefinitionQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsWorkflowWorkflowDefinitionQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsWorkflowWorkflowDefinitionQuerySortAscending]): Field sort
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsWorkflowWorkflowDefinitionQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsWorkflowWorkflowDefinitionQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsWorkflowWorkflowDefinitionQuerySortAscending(_sort_ascending)

        models_query_models_workflow_workflow_definition_query = cls(
        ...
        models_query_models_workflow_workflow_definition_query.additional_properties = d
        return models_query_models_workflow_workflow_definition_query
