...
from ..models.models_query_models_paged_certificate_authority_query_sort_ascending import (
    ModelsQueryModelsPagedCertificateAuthorityQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedCertificateAuthorityQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedCertificateAuthorityQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedCertificateAuthorityQuerySortAscending]): Field sort
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateAuthorityQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateAuthorityQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedCertificateAuthorityQuerySortAscending(_sort_ascending)

        models_query_models_paged_certificate_authority_query = cls(
        ...
        models_query_models_paged_certificate_authority_query.additional_properties = d
        return models_query_models_paged_certificate_authority_query
