...
from ..models.models_query_models_paged_ssh_server_query_sort_ascending import (
    ModelsQueryModelsPagedSSHServerQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedSSHServerQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedSSHServerQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedSSHServerQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHServerQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHServerQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedSSHServerQuerySortAscending(_sort_ascending)

        models_query_models_paged_ssh_server_query = cls(
        ...
        models_query_models_paged_ssh_server_query.additional_properties = d
        return models_query_models_paged_ssh_server_query
