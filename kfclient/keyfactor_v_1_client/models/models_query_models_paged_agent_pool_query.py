...
from ..models.models_query_models_paged_agent_pool_query_sort_ascending import (
    ModelsQueryModelsPagedAgentPoolQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedAgentPoolQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedAgentPoolQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedAgentPoolQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentPoolQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentPoolQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedAgentPoolQuerySortAscending(_sort_ascending)

        models_query_models_paged_agent_pool_query = cls(
        ...
        models_query_models_paged_agent_pool_query.additional_properties = d
        return models_query_models_paged_agent_pool_query
