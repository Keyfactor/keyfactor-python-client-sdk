...
from ..models.models_query_models_paged_denied_alert_query_sort_ascending import (
    ModelsQueryModelsPagedDeniedAlertQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedDeniedAlertQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedDeniedAlertQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedDeniedAlertQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedDeniedAlertQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedDeniedAlertQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedDeniedAlertQuerySortAscending(_sort_ascending)

        models_query_models_paged_denied_alert_query = cls(
        ...
        models_query_models_paged_denied_alert_query.additional_properties = d
        return models_query_models_paged_denied_alert_query
