...
T = TypeVar("T", bound="ModelsTemplateRegex")


@attr.s(auto_attribs=True)
class ModelsTemplateRegex:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        models_template_regex.additional_properties = d
        return models_template_regex
