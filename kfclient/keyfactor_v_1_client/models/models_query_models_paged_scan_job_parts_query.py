...
from ..models.models_query_models_paged_scan_job_parts_query_job_type import (
    ModelsQueryModelsPagedScanJobPartsQueryJobType,
)
from ..models.models_query_models_paged_scan_job_parts_query_sort_ascending import (
    ModelsQueryModelsPagedScanJobPartsQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedScanJobPartsQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedScanJobPartsQuery:
    """
    Attributes:
        job_type (Union[Unset, ModelsQueryModelsPagedScanJobPartsQueryJobType]):
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedScanJobPartsQuerySortAscending]): Field sort direction
            [0=ascending, 1=descending]
    """

    job_type: Union[Unset, ModelsQueryModelsPagedScanJobPartsQueryJobType] = UNSET
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedScanJobPartsQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_job_type, Unset):
            ...
            job_type = ModelsQueryModelsPagedScanJobPartsQueryJobType(_job_type)
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedScanJobPartsQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedScanJobPartsQuerySortAscending(_sort_ascending)

        models_query_models_paged_scan_job_parts_query = cls(
            job_type=job_type,
        ...
        models_query_models_paged_scan_job_parts_query.additional_properties = d
        return models_query_models_paged_scan_job_parts_query
