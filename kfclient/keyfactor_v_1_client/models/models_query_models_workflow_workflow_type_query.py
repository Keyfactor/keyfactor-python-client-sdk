...
from ..models.models_query_models_workflow_workflow_type_query_sort_ascending import (
    ModelsQueryModelsWorkflowWorkflowTypeQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsWorkflowWorkflowTypeQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsWorkflowWorkflowTypeQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsWorkflowWorkflowTypeQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsWorkflowWorkflowTypeQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsWorkflowWorkflowTypeQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsWorkflowWorkflowTypeQuerySortAscending(_sort_ascending)

        models_query_models_workflow_workflow_type_query = cls(
        ...
        models_query_models_workflow_workflow_type_query.additional_properties = d
        return models_query_models_workflow_workflow_type_query
