...
T = TypeVar("T", bound="ModelsTemplateRetrievalResponseTemplatePolicyModel")


@attr.s(auto_attribs=True)
class ModelsTemplateRetrievalResponseTemplatePolicyModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        models_template_retrieval_response_template_policy_model = cls(
        ...
        models_template_retrieval_response_template_policy_model.additional_properties = d
        return models_template_retrieval_response_template_policy_model
