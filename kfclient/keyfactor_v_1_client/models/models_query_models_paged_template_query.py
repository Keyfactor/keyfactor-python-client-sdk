...
from ..models.models_query_models_paged_template_query_sort_ascending import (
    ModelsQueryModelsPagedTemplateQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedTemplateQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedTemplateQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedTemplateQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedTemplateQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedTemplateQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedTemplateQuerySortAscending(_sort_ascending)

        models_query_models_paged_template_query = cls(
        ...
        models_query_models_paged_template_query.additional_properties = d
        return models_query_models_paged_template_query
