...
T = TypeVar("T", bound="ModelsTemplateUpdateRequestTemplateRegexModel")


@attr.s(auto_attribs=True)
class ModelsTemplateUpdateRequestTemplateRegexModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        models_template_update_request_template_regex_model = cls(
        ...
        models_template_update_request_template_regex_model.additional_properties = d
        return models_template_update_request_template_regex_model
