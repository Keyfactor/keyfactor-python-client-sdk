...
from ..models.models_query_models_paged_agent_job_history_query_sort_ascending import (
    ModelsQueryModelsPagedAgentJobHistoryQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedAgentJobHistoryQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedAgentJobHistoryQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedAgentJobHistoryQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentJobHistoryQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentJobHistoryQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedAgentJobHistoryQuerySortAscending(_sort_ascending)

        models_query_models_paged_agent_job_history_query = cls(
        ...
        models_query_models_paged_agent_job_history_query.additional_properties = d
        return models_query_models_paged_agent_job_history_query
