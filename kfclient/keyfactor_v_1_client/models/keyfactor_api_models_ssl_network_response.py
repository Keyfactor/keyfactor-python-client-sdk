...
from ..models.keyfactor_api_models_ssl_network_response_discover_status import (
    KeyfactorApiModelsSslNetworkResponseDiscoverStatus,
)
from ..models.keyfactor_api_models_ssl_network_response_monitor_status import (
    KeyfactorApiModelsSslNetworkResponseMonitorStatus,
)
...
T = TypeVar("T", bound="KeyfactorApiModelsSslNetworkResponse")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsSslNetworkResponse:
    """
    Attributes:
        ...
        discover_status (Union[Unset, KeyfactorApiModelsSslNetworkResponseDiscoverStatus]):
        monitor_status (Union[Unset, KeyfactorApiModelsSslNetworkResponseMonitorStatus]):
    ...
    discover_status: Union[Unset, KeyfactorApiModelsSslNetworkResponseDiscoverStatus] = UNSET
    monitor_status: Union[Unset, KeyfactorApiModelsSslNetworkResponseMonitorStatus] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_discover_status, Unset):
            ...
            discover_status = KeyfactorApiModelsSslNetworkResponseDiscoverStatus(_discover_status)
        ...
        if isinstance(_monitor_status, Unset):
            ...
            monitor_status = KeyfactorApiModelsSslNetworkResponseMonitorStatus(_monitor_status)
        ...
        keyfactor_api_models_ssl_network_response = cls(
        ...
        keyfactor_api_models_ssl_network_response.additional_properties = d
        return keyfactor_api_models_ssl_network_response
