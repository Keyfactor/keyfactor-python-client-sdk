...
from ..models.models_paged_query_sort_ascending import ModelsPagedQuerySortAscending
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsPagedQuery")


@attr.s(auto_attribs=True)
class ModelsPagedQuery:
    ...
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsPagedQuerySortAscending]): Field sort direction [0=ascending, 1=descending]
    """
    ...
    sort_ascending: Union[Unset, ModelsPagedQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsPagedQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsPagedQuerySortAscending(_sort_ascending)

        models_paged_query = cls(
        ...
        models_paged_query.additional_properties = d
        return models_paged_query
