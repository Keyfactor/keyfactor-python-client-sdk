...
T = TypeVar("T", bound="KeyfactorApiModelsAlertsDeniedDeniedAlertCreationRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsAlertsDeniedDeniedAlertCreationRequest:
    """
    Attributes:
        display_name (str):
        subject (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_alerts_denied_denied_alert_creation_request = cls(
        ...
        keyfactor_api_models_alerts_denied_denied_alert_creation_request.additional_properties = d
        return keyfactor_api_models_alerts_denied_denied_alert_creation_request
