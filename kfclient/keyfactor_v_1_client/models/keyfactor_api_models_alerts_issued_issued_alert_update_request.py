...
T = TypeVar("T", bound="KeyfactorApiModelsAlertsIssuedIssuedAlertUpdateRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsAlertsIssuedIssuedAlertUpdateRequest:
    """
    Attributes:
        display_name (str):
        subject (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_alerts_issued_issued_alert_update_request = cls(
        ...
        keyfactor_api_models_alerts_issued_issued_alert_update_request.additional_properties = d
        return keyfactor_api_models_alerts_issued_issued_alert_update_request
