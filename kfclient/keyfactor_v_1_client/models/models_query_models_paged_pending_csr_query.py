...
from ..models.models_query_models_paged_pending_csr_query_sort_ascending import (
    ModelsQueryModelsPagedPendingCSRQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedPendingCSRQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedPendingCSRQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedPendingCSRQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedPendingCSRQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedPendingCSRQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedPendingCSRQuerySortAscending(_sort_ascending)

        models_query_models_paged_pending_csr_query = cls(
        ...
        models_query_models_paged_pending_csr_query.additional_properties = d
        return models_query_models_paged_pending_csr_query
