...
from ..models.models_query_models_paged_certificate_store_server_query_sort_ascending import (
    ModelsQueryModelsPagedCertificateStoreServerQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedCertificateStoreServerQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedCertificateStoreServerQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedCertificateStoreServerQuerySortAscending]): Field sort
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateStoreServerQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateStoreServerQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedCertificateStoreServerQuerySortAscending(_sort_ascending)

        models_query_models_paged_certificate_store_server_query = cls(
        ...
        models_query_models_paged_certificate_store_server_query.additional_properties = d
        return models_query_models_paged_certificate_store_server_query
