...
from ..models.models_query_models_paged_certificate_request_query_sort_ascending import (
    ModelsQueryModelsPagedCertificateRequestQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedCertificateRequestQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedCertificateRequestQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedCertificateRequestQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateRequestQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateRequestQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedCertificateRequestQuerySortAscending(_sort_ascending)

        models_query_models_paged_certificate_request_query = cls(
        ...
        models_query_models_paged_certificate_request_query.additional_properties = d
        return models_query_models_paged_certificate_request_query
