...
class KeyfactorApiModelsTemplatesTemplateEnrollmentPolicyResponse:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_templates_template_enrollment_policy_response = cls(
        ...
        keyfactor_api_models_templates_template_enrollment_policy_response.additional_properties = d
        return keyfactor_api_models_templates_template_enrollment_policy_response
