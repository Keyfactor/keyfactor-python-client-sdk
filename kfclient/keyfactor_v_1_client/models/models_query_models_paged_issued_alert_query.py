...
from ..models.models_query_models_paged_issued_alert_query_sort_ascending import (
    ModelsQueryModelsPagedIssuedAlertQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedIssuedAlertQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedIssuedAlertQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedIssuedAlertQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedIssuedAlertQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedIssuedAlertQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedIssuedAlertQuerySortAscending(_sort_ascending)

        models_query_models_paged_issued_alert_query = cls(
        ...
        models_query_models_paged_issued_alert_query.additional_properties = d
        return models_query_models_paged_issued_alert_query
