...
from ..models.models_query_models_paged_metadata_field_query_sort_ascending import (
    ModelsQueryModelsPagedMetadataFieldQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedMetadataFieldQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedMetadataFieldQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedMetadataFieldQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedMetadataFieldQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedMetadataFieldQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedMetadataFieldQuerySortAscending(_sort_ascending)

        models_query_models_paged_metadata_field_query = cls(
        ...
        models_query_models_paged_metadata_field_query.additional_properties = d
        return models_query_models_paged_metadata_field_query
