...
from ..models.models_query_models_paged_ssh_user_query_sort_ascending import (
    ModelsQueryModelsPagedSSHUserQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedSSHUserQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedSSHUserQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedSSHUserQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHUserQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHUserQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedSSHUserQuerySortAscending(_sort_ascending)

        models_query_models_paged_ssh_user_query = cls(
        ...
        models_query_models_paged_ssh_user_query.additional_properties = d
        return models_query_models_paged_ssh_user_query
