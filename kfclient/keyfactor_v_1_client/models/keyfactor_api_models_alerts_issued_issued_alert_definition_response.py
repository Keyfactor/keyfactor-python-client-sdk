...
T = TypeVar("T", bound="KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse:
    """
    Attributes:
        id (Union[Unset, int]):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_alerts_issued_issued_alert_definition_response = cls(
            id=id,
        ...
        keyfactor_api_models_alerts_issued_issued_alert_definition_response.additional_properties = d
        return keyfactor_api_models_alerts_issued_issued_alert_definition_response
