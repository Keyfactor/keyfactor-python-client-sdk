...
from ..models.models_query_models_paged_report_schedule_query_sort_ascending import (
    ModelsQueryModelsPagedReportScheduleQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedReportScheduleQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedReportScheduleQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedReportScheduleQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedReportScheduleQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedReportScheduleQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedReportScheduleQuerySortAscending(_sort_ascending)

        models_query_models_paged_report_schedule_query = cls(
        ...
        models_query_models_paged_report_schedule_query.additional_properties = d
        return models_query_models_paged_report_schedule_query
