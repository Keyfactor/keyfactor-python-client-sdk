...
from ..models.models_query_models_paged_report_query_sort_ascending import (
    ModelsQueryModelsPagedReportQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedReportQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedReportQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedReportQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedReportQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedReportQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedReportQuerySortAscending(_sort_ascending)

        models_query_models_paged_report_query = cls(
        ...
        models_query_models_paged_report_query.additional_properties = d
        return models_query_models_paged_report_query
