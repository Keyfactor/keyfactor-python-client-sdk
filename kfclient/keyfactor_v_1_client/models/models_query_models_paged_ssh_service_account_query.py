...
from ..models.models_query_models_paged_ssh_service_account_query_sort_ascending import (
    ModelsQueryModelsPagedSSHServiceAccountQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedSSHServiceAccountQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedSSHServiceAccountQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedSSHServiceAccountQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHServiceAccountQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHServiceAccountQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedSSHServiceAccountQuerySortAscending(_sort_ascending)

        models_query_models_paged_ssh_service_account_query = cls(
        ...
        models_query_models_paged_ssh_service_account_query.additional_properties = d
        return models_query_models_paged_ssh_service_account_query
