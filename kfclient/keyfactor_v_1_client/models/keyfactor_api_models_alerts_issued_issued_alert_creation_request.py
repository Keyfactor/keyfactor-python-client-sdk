...
T = TypeVar("T", bound="KeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsAlertsIssuedIssuedAlertCreationRequest:
    """
    Attributes:
        display_name (str):
        subject (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_alerts_issued_issued_alert_creation_request = cls(
        ...
        keyfactor_api_models_alerts_issued_issued_alert_creation_request.additional_properties = d
        return keyfactor_api_models_alerts_issued_issued_alert_creation_request
