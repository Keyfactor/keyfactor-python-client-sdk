...
T = TypeVar("T", bound="KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestAllRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertTestAllRequest:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_alerts_key_rotation_key_rotation_alert_test_all_request = cls(
            evaluation_date=evaluation_date,
            previous_evaluation_date=previous_evaluation_date,
            send_alerts=send_alerts,
        )

        keyfactor_api_models_alerts_key_rotation_key_rotation_alert_test_all_request.additional_properties = d
        return keyfactor_api_models_alerts_key_rotation_key_rotation_alert_test_all_request
