...
T = TypeVar("T", bound="KeyfactorApiModelsMonitoringRevocationMonitoringUpdateRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsMonitoringRevocationMonitoringUpdateRequest:
    """
    Attributes:
        name (str):
        endpoint_type (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_monitoring_revocation_monitoring_update_request = cls(
            name=name,
        ...
        keyfactor_api_models_monitoring_revocation_monitoring_update_request.additional_properties = d
        return keyfactor_api_models_monitoring_revocation_monitoring_update_request
