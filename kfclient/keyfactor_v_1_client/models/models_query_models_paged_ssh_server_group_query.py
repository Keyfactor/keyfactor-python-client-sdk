...
from ..models.models_query_models_paged_ssh_server_group_query_sort_ascending import (
    ModelsQueryModelsPagedSSHServerGroupQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedSSHServerGroupQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedSSHServerGroupQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedSSHServerGroupQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHServerGroupQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedSSHServerGroupQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedSSHServerGroupQuerySortAscending(_sort_ascending)

        models_query_models_paged_ssh_server_group_query = cls(
        ...
        models_query_models_paged_ssh_server_group_query.additional_properties = d
        return models_query_models_paged_ssh_server_group_query
