...
T = TypeVar("T", bound="KeyfactorApiModelsWorkflowsAvailableStepResponseConfigurationParametersDefinition")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsWorkflowsAvailableStepResponseConfigurationParametersDefinition:
    """ """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        keyfactor_api_models_workflows_available_step_response_configuration_parameters_definition = cls()
        ...
        keyfactor_api_models_workflows_available_step_response_configuration_parameters_definition.additional_properties = (
            additional_properties
        )
        return keyfactor_api_models_workflows_available_step_response_configuration_parameters_definition
