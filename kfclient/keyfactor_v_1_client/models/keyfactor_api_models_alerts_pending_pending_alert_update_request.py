...
T = TypeVar("T", bound="KeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsAlertsPendingPendingAlertUpdateRequest:
    """
    Attributes:
        display_name (str):
        subject (str):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_alerts_pending_pending_alert_update_request = cls(
        ...
        keyfactor_api_models_alerts_pending_pending_alert_update_request.additional_properties = d
        return keyfactor_api_models_alerts_pending_pending_alert_update_request
