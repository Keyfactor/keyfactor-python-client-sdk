...
T = TypeVar("T", bound="KeyfactorAPIModelsSMTPSMTPTestResponse")


@attr.s(auto_attribs=True)
class KeyfactorAPIModelsSMTPSMTPTestResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_smtpsmtp_test_response = cls(
            host=host,
            id=id,
            port=port,
        ...
        keyfactor_api_models_smtpsmtp_test_response.additional_properties = d
        return keyfactor_api_models_smtpsmtp_test_response
