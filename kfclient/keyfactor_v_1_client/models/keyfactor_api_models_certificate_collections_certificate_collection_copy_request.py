...
from ..models.keyfactor_api_models_certificate_collections_certificate_collection_copy_request_duplication_field import (
    KeyfactorApiModelsCertificateCollectionsCertificateCollectionCopyRequestDuplicationField,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="KeyfactorApiModelsCertificateCollectionsCertificateCollectionCopyRequest")


@attr.s(auto_attribs=True)
class KeyfactorApiModelsCertificateCollectionsCertificateCollectionCopyRequest:
    """
    Attributes:
        copy_from_id (int):
        name (str):
    ...
    duplication_field: Union[
        Unset, KeyfactorApiModelsCertificateCollectionsCertificateCollectionCopyRequestDuplicationField
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        keyfactor_api_models_certificate_collections_certificate_collection_copy_request = cls(
        ...
        keyfactor_api_models_certificate_collections_certificate_collection_copy_request.additional_properties = d
        return keyfactor_api_models_certificate_collections_certificate_collection_copy_request
