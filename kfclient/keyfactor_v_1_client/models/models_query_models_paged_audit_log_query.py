...
from ..models.models_query_models_paged_audit_log_query_sort_ascending import (
    ModelsQueryModelsPagedAuditLogQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedAuditLogQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedAuditLogQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedAuditLogQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedAuditLogQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedAuditLogQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedAuditLogQuerySortAscending(_sort_ascending)

        models_query_models_paged_audit_log_query = cls(
        ...
        models_query_models_paged_audit_log_query.additional_properties = d
        return models_query_models_paged_audit_log_query
