...
from ..models.models_query_models_paged_certificate_store_query_sort_ascending import (
    ModelsQueryModelsPagedCertificateStoreQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedCertificateStoreQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedCertificateStoreQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedCertificateStoreQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateStoreQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateStoreQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedCertificateStoreQuerySortAscending(_sort_ascending)

        models_query_models_paged_certificate_store_query = cls(
        ...
        models_query_models_paged_certificate_store_query.additional_properties = d
        return models_query_models_paged_certificate_store_query
