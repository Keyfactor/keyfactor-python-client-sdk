...
from ..models.models_query_models_paged_certificate_store_inventory_query_sort_ascending import (
    ModelsQueryModelsPagedCertificateStoreInventoryQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedCertificateStoreInventoryQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedCertificateStoreInventoryQuery:
    """
    Attributes:
        ...
        sort_field (Union[Unset, str]): Field by which the results should be sorted (OperationStart, OperationEnd,
            UserName)
        sort_ascending (Union[Unset, ModelsQueryModelsPagedCertificateStoreInventoryQuerySortAscending]): Field sort
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateStoreInventoryQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedCertificateStoreInventoryQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedCertificateStoreInventoryQuerySortAscending(_sort_ascending)

        models_query_models_paged_certificate_store_inventory_query = cls(
        ...
        models_query_models_paged_certificate_store_inventory_query.additional_properties = d
        return models_query_models_paged_certificate_store_inventory_query
