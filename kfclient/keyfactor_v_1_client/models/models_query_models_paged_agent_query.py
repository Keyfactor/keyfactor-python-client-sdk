...
from ..models.models_query_models_paged_agent_query_sort_ascending import ModelsQueryModelsPagedAgentQuerySortAscending
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedAgentQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedAgentQuery:
    ...
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedAgentQuerySortAscending]): Field sort direction [0=ascending,
            1=descending]
    """
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedAgentQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedAgentQuerySortAscending(_sort_ascending)

        models_query_models_paged_agent_query = cls(
        ...
        models_query_models_paged_agent_query.additional_properties = d
        return models_query_models_paged_agent_query
