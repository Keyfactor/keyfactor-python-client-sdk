...
from ..models.models_query_models_paged_legacy_denied_request_query_sort_ascending import (
    ModelsQueryModelsPagedLegacyDeniedRequestQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedLegacyDeniedRequestQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedLegacyDeniedRequestQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedLegacyDeniedRequestQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedLegacyDeniedRequestQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedLegacyDeniedRequestQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedLegacyDeniedRequestQuerySortAscending(_sort_ascending)

        models_query_models_paged_legacy_denied_request_query = cls(
        ...
        models_query_models_paged_legacy_denied_request_query.additional_properties = d
        return models_query_models_paged_legacy_denied_request_query
