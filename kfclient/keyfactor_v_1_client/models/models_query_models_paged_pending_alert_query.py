...
from ..models.models_query_models_paged_pending_alert_query_sort_ascending import (
    ModelsQueryModelsPagedPendingAlertQuerySortAscending,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ModelsQueryModelsPagedPendingAlertQuery")


@attr.s(auto_attribs=True)
class ModelsQueryModelsPagedPendingAlertQuery:
    """
    Attributes:
        ...
        sort_ascending (Union[Unset, ModelsQueryModelsPagedPendingAlertQuerySortAscending]): Field sort direction
    ...
    sort_ascending: Union[Unset, ModelsQueryModelsPagedPendingAlertQuerySortAscending] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sort_ascending: Union[Unset, ModelsQueryModelsPagedPendingAlertQuerySortAscending]
        if isinstance(_sort_ascending, Unset):
            sort_ascending = UNSET
        else:
            sort_ascending = ModelsQueryModelsPagedPendingAlertQuerySortAscending(_sort_ascending)

        models_query_models_paged_pending_alert_query = cls(
        ...
        models_query_models_paged_pending_alert_query.additional_properties = d
        return models_query_models_paged_pending_alert_query
