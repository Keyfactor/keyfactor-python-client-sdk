...
from ...models.certificate_store_container_get_all_certificate_store_containers_pq_sort_ascending import (
    CertificateStoreContainerGetAllCertificateStoreContainersPqSortAscending,
)
from ...models.models_certificate_store_container_list_response import ModelsCertificateStoreContainerListResponse
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[
        Unset, None, CertificateStoreContainerGetAllCertificateStoreContainersPqSortAscending
    ] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/CertificateStoreContainers".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsCertificateStoreContainerListResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsCertificateStoreContainerListResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsCertificateStoreContainerListResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsCertificateStoreContainerListResponse]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None,
            CertificateStoreContainerGetAllCertificateStoreContainersPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsCertificateStoreContainerListResponse]]:
    """Returns all certificate store container according to the provided filter and output parameters
