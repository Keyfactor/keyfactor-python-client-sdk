...
from ...models.keyfactor_api_models_certificate_stores_add_certificate_request import (
...
def _get_kwargs(
    *,
    client: Client,
    json_body: KeyfactorApiModelsCertificateStoresAddCertificateRequest,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/CertificateStores/Certificates/Add".format(client.base_url)
