...
from ...models.keyfactor_api_models_alerts_pending_pending_alert_test_all_request import (
...
def _get_kwargs(
    *,
    client: Client,
    json_body: KeyfactorApiModelsAlertsPendingPendingAlertTestAllRequest,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Alerts/Pending/TestAll".format(client.base_url)
