...
from ...models.reports_get_report_schedules_pq_sort_ascending import ReportsGetReportSchedulesPqSortAscending
...
def _get_kwargs(
    ...
    *,
    ...
    pq_sort_ascending: Union[Unset, None, ReportsGetReportSchedulesPqSortAscending] = UNSET,
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsReportSchedule]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsReportSchedule.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsReportSchedule]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsReportSchedule]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, ReportsGetReportSchedulesPqSortAscending]):
...
def sync(
    ...
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsReportSchedule]]:
    """Get a built-in report's schedules that matches the id of the report.
