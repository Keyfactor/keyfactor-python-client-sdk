...
from ...models.models_custom_report import ModelsCustomReport
from ...models.reports_query_custom_reports_query_sort_ascending import ReportsQueryCustomReportsQuerySortAscending
...
def _get_kwargs(
    *,
    ...
    query_sort_ascending: Union[Unset, None, ReportsQueryCustomReportsQuerySortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Reports/Custom".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsCustomReport]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsCustomReport.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsCustomReport]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsCustomReport]]:
    ...
    Args:
        ...
        query_sort_ascending (Union[Unset, None, ReportsQueryCustomReportsQuerySortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsCustomReport]]:
    """Returns all custom reports according to the provided filter and output parameters
