...
from ...models.models_report_request_model import ModelsReportRequestModel
...
def _get_kwargs(
    *,
    client: Client,
    form_data: ModelsReportRequestModel,
    json_body: ModelsReportRequestModel,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        json_body (ModelsReportRequestModel): The ReportRequestModel can be used to update a
            report.
