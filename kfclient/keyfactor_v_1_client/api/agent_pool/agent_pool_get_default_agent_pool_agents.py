...
from ...models.agent_pool_get_default_agent_pool_agents_pq_sort_ascending import (
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, AgentPoolGetDefaultAgentPoolAgentsPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/AgentPools/Agents".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsAgentsAgentPoolAgent]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsAgentsAgentPoolAgent.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsAgentsAgentPoolAgent]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsAgentsAgentPoolAgent]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, AgentPoolGetDefaultAgentPoolAgentsPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsAgentsAgentPoolAgent]]:
    """Returns all agents for the default agent pool
