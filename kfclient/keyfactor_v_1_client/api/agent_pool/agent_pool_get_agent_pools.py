...
from ...models.agent_pool_get_agent_pools_pq_sort_ascending import AgentPoolGetAgentPoolsPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, AgentPoolGetAgentPoolsPqSortAscending] = UNSET,
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsAgentsAgentPool]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsAgentsAgentPool.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsAgentsAgentPool]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsAgentsAgentPool]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, AgentPoolGetAgentPoolsPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsAgentsAgentPool]]:
    """Returns all agent pools according to the provided filter and output parameters
