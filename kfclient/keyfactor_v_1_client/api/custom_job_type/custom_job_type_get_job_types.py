...
from ...models.custom_job_type_get_job_types_pq_sort_ascending import CustomJobTypeGetJobTypesPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, CustomJobTypeGetJobTypesPqSortAscending] = UNSET,
...
def _parse_response(*, response: httpx.Response) -> Optional[List[KeyfactorApiModelsOrchestratorJobsJobTypeResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsOrchestratorJobsJobTypeResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[KeyfactorApiModelsOrchestratorJobsJobTypeResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[KeyfactorApiModelsOrchestratorJobsJobTypeResponse]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, CustomJobTypeGetJobTypesPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[KeyfactorApiModelsOrchestratorJobsJobTypeResponse]]:
    """Returns all custom job types according to the provided filter and output parameters
