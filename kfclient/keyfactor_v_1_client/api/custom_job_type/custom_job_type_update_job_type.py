...
from ...models.models_orchestrator_jobs_job_type_update_request import ModelsOrchestratorJobsJobTypeUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    form_data: ModelsOrchestratorJobsJobTypeUpdateRequest,
    json_body: ModelsOrchestratorJobsJobTypeUpdateRequest,
