...
from ...models.issued_alert_get_issued_alerts_paged_query_sort_ascending import (
    IssuedAlertGetIssuedAlertsPagedQuerySortAscending,
)
...
def _get_kwargs(
    *,
    ...
    paged_query_sort_ascending: Union[Unset, None, IssuedAlertGetIssuedAlertsPagedQuerySortAscending] = UNSET,
...
) -> Optional[List[KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse.from_dict(
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[KeyfactorApiModelsAlertsIssuedIssuedAlertDefinitionResponse]]:
    return Response(
