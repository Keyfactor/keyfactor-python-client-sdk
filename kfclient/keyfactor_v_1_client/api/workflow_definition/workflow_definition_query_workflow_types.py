...
from ...models.keyfactor_api_models_workflows_workflow_type_query_response import (
    KeyfactorApiModelsWorkflowsWorkflowTypeQueryResponse,
)
from ...models.workflow_definition_query_workflow_types_query_sort_ascending import (
...
def _get_kwargs(
    *,
    ...
    query_sort_ascending: Union[Unset, None, WorkflowDefinitionQueryWorkflowTypesQuerySortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Workflow/Definitions/Types".format(client.base_url)
...
) -> Optional[List[KeyfactorApiModelsWorkflowsWorkflowTypeQueryResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsWorkflowsWorkflowTypeQueryResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[KeyfactorApiModelsWorkflowsWorkflowTypeQueryResponse]]:
    return Response(
