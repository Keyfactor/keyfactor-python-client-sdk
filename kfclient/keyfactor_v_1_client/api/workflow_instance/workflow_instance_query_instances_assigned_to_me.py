...
from ...models.workflow_instance_query_instances_assigned_to_me_pq_sort_ascending import (
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, WorkflowInstanceQueryInstancesAssignedToMePqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Workflow/Instances/AssignedToMe".format(client.base_url)
