...
from ...models.workflow_instance_query_pq_sort_ascending import WorkflowInstanceQueryPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, WorkflowInstanceQueryPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Workflow/Instances".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, WorkflowInstanceQueryPqSortAscending]):
