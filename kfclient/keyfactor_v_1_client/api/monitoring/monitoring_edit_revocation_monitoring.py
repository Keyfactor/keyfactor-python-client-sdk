...
from ...models.keyfactor_api_models_monitoring_revocation_monitoring_update_request import (
...
def _get_kwargs(
    *,
    client: Client,
    form_data: KeyfactorApiModelsMonitoringRevocationMonitoringUpdateRequest,
    json_body: KeyfactorApiModelsMonitoringRevocationMonitoringUpdateRequest,
