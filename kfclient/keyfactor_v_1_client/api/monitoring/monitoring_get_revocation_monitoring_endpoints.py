...
from ...models.monitoring_get_revocation_monitoring_endpoints_paged_query_sort_ascending import (
...
def _get_kwargs(
    *,
    ...
    paged_query_sort_ascending: Union[
        Unset, None, MonitoringGetRevocationMonitoringEndpointsPagedQuerySortAscending
    ] = UNSET,
...
) -> Optional[List[KeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse.from_dict(
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[KeyfactorApiModelsMonitoringRevocationMonitoringDefinitionResponse]]:
    return Response(
