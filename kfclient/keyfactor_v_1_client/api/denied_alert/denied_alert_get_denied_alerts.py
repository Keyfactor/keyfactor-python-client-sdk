...
from ...models.denied_alert_get_denied_alerts_paged_query_sort_ascending import (
    DeniedAlertGetDeniedAlertsPagedQuerySortAscending,
)
...
def _get_kwargs(
    *,
    ...
    paged_query_sort_ascending: Union[Unset, None, DeniedAlertGetDeniedAlertsPagedQuerySortAscending] = UNSET,
...
) -> Optional[List[KeyfactorApiModelsAlertsDeniedDeniedAlertDefinitionResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsAlertsDeniedDeniedAlertDefinitionResponse.from_dict(
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[KeyfactorApiModelsAlertsDeniedDeniedAlertDefinitionResponse]]:
    return Response(
