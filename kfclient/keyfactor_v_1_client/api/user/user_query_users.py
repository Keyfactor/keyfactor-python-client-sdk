...
from ...models.user_query_users_pq_sort_ascending import UserQueryUsersPqSortAscending
...
def _get_kwargs(
    *,
    client: Client,
    show_owned_access: Union[Unset, None, bool] = UNSET,
    ...
    pq_sort_ascending: Union[Unset, None, UserQueryUsersPqSortAscending] = UNSET,
    ...
    params: Dict[str, Any] = {}
    params["showOwnedAccess"] = show_owned_access
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsSSHUsersSshUserResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsSSHUsersSshUserResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsSSHUsersSshUserResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsSSHUsersSshUserResponse]]:
    """Returns users matching the criteria from the provided query parameters

    Args:
        show_owned_access (Union[Unset, None, bool]):
        ...
        pq_sort_ascending (Union[Unset, None, UserQueryUsersPqSortAscending]):
    ...
    kwargs = _get_kwargs(
        client=client,
        show_owned_access=show_owned_access,
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsSSHUsersSshUserResponse]]:
    """Returns users matching the criteria from the provided query parameters
