...
from ...models.keyfactor_api_models_certificate_stores_job_history_response import (
    KeyfactorApiModelsCertificateStoresJobHistoryResponse,
)
from ...models.orchestrator_job_get_job_history_pq_sort_ascending import OrchestratorJobGetJobHistoryPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, OrchestratorJobGetJobHistoryPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/OrchestratorJobs/JobHistory".format(client.base_url)
...
) -> Optional[List[KeyfactorApiModelsCertificateStoresJobHistoryResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsCertificateStoresJobHistoryResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[KeyfactorApiModelsCertificateStoresJobHistoryResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, OrchestratorJobGetJobHistoryPqSortAscending]):
