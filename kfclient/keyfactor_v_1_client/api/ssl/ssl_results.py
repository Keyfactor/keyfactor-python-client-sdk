...
from ...models.models_ssl_ssl_scan_result import ModelsSSLSslScanResult
from ...models.ssl_results_pq_sort_ascending import SslResultsPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, SslResultsPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/SSL".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsSSLSslScanResult]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsSSLSslScanResult.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsSSLSslScanResult]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsSSLSslScanResult]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, SslResultsPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsSSLSslScanResult]]:
    """Returns a list of the endpoint scan results according to the provided filter and output parameters
