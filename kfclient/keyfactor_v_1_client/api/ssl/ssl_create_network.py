...
from ...models.keyfactor_api_models_ssl_create_network_request import KeyfactorApiModelsSslCreateNetworkRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: KeyfactorApiModelsSslCreateNetworkRequest,
