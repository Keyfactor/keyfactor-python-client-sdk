...
from ...models.keyfactor_api_models_ssl_network_query_response import KeyfactorApiModelsSslNetworkQueryResponse
from ...models.ssl_get_networks_sq_sort_ascending import SslGetNetworksSqSortAscending
...
def _get_kwargs(
    *,
    ...
    sq_sort_ascending: Union[Unset, None, SslGetNetworksSqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/SSL/Networks".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[KeyfactorApiModelsSslNetworkQueryResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsSslNetworkQueryResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[KeyfactorApiModelsSslNetworkQueryResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[KeyfactorApiModelsSslNetworkQueryResponse]]:
    ...
    Args:
        ...
        sq_sort_ascending (Union[Unset, None, SslGetNetworksSqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[KeyfactorApiModelsSslNetworkQueryResponse]]:
    """Returns all defined SSL networks according to the provided filter and output parameters
