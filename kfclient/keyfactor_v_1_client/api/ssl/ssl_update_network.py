...
from ...models.keyfactor_api_models_ssl_update_network_request import KeyfactorApiModelsSslUpdateNetworkRequest
...
def _get_kwargs(
    *,
    client: Client,
    form_data: KeyfactorApiModelsSslUpdateNetworkRequest,
    json_body: KeyfactorApiModelsSslUpdateNetworkRequest,
