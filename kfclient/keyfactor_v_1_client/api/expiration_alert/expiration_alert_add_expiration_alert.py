...
from ...models.keyfactor_api_models_alerts_expiration_expiration_alert_creation_request import (
...
def _get_kwargs(
    *,
    client: Client,
    json_body: KeyfactorApiModelsAlertsExpirationExpirationAlertCreationRequest,
