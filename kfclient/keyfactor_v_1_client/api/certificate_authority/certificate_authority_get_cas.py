...
from ...models.certificate_authority_get_cas_pq_sort_ascending import CertificateAuthorityGetCasPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, CertificateAuthorityGetCasPqSortAscending] = UNSET,
...
) -> Optional[List[ModelsCertificateAuthoritiesCertificateAuthorityResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsCertificateAuthoritiesCertificateAuthorityResponse.from_dict(
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[ModelsCertificateAuthoritiesCertificateAuthorityResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, CertificateAuthorityGetCasPqSortAscending]):
