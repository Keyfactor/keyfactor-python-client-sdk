...
from ...models.workflow_get_paged_query_sort_ascending import WorkflowGetPagedQuerySortAscending
...
def _get_kwargs(
    *,
    ...
    paged_query_sort_ascending: Union[Unset, None, WorkflowGetPagedQuerySortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Workflow/Certificates/Pending".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        paged_query_sort_ascending (Union[Unset, None, WorkflowGetPagedQuerySortAscending]):
