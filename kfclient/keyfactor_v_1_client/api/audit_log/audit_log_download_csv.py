...
from ...models.audit_log_download_csv_pq_sort_ascending import AuditLogDownloadCSVPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, AuditLogDownloadCSVPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Audit/Download".format(client.base_url)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, AuditLogDownloadCSVPqSortAscending]):
