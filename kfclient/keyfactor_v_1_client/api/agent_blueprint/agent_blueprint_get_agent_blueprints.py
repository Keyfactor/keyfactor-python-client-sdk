...
from ...models.agent_blueprint_get_agent_blueprints_pq_sort_ascending import (
    AgentBlueprintGetAgentBlueprintsPqSortAscending,
)
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, AgentBlueprintGetAgentBlueprintsPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/AgentBluePrint".format(client.base_url)
...
) -> Optional[List[KeyfactorApiModelsOrchestratorsAgentBlueprintResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsOrchestratorsAgentBlueprintResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[KeyfactorApiModelsOrchestratorsAgentBlueprintResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, AgentBlueprintGetAgentBlueprintsPqSortAscending]):
