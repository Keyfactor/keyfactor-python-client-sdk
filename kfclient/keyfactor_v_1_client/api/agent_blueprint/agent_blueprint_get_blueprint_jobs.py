...
from ...models.agent_blueprint_get_blueprint_jobs_pq_sort_ascending import AgentBlueprintGetBlueprintJobsPqSortAscending
from ...models.keyfactor_api_models_orchestrators_agent_blueprint_jobs_response import (
...
def _get_kwargs(
    ...
    *,
    ...
    pq_sort_ascending: Union[Unset, None, AgentBlueprintGetBlueprintJobsPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/AgentBluePrint/{id}/Jobs".format(client.base_url, id=id)
...
) -> Optional[List[KeyfactorApiModelsOrchestratorsAgentBlueprintJobsResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsOrchestratorsAgentBlueprintJobsResponse.from_dict(
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[KeyfactorApiModelsOrchestratorsAgentBlueprintJobsResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, AgentBlueprintGetBlueprintJobsPqSortAscending]):
