...
from ...models.agent_blueprint_get_blueprint_stores_pq_sort_ascending import (
    AgentBlueprintGetBlueprintStoresPqSortAscending,
)
...
def _get_kwargs(
    ...
    *,
    ...
    pq_sort_ascending: Union[Unset, None, AgentBlueprintGetBlueprintStoresPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/AgentBluePrint/{id}/Stores".format(client.base_url, id=id)
...
) -> Optional[List[KeyfactorApiModelsOrchestratorsAgentBlueprintStoresResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsOrchestratorsAgentBlueprintStoresResponse.from_dict(
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[KeyfactorApiModelsOrchestratorsAgentBlueprintStoresResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, AgentBlueprintGetBlueprintStoresPqSortAscending]):
