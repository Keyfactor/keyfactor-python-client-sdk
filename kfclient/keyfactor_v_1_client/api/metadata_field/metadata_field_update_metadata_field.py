...
from ...models.keyfactor_api_models_metadata_field_metadata_field_update_request import (
...
def _get_kwargs(
    *,
    client: Client,
    form_data: KeyfactorApiModelsMetadataFieldMetadataFieldUpdateRequest,
    json_body: KeyfactorApiModelsMetadataFieldMetadataFieldUpdateRequest,
