...
from ...models.metadata_field_get_all_metadata_fields_pq_sort_ascending import (
    MetadataFieldGetAllMetadataFieldsPqSortAscending,
)
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, MetadataFieldGetAllMetadataFieldsPqSortAscending] = UNSET,
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsMetadataFieldTypeModel]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsMetadataFieldTypeModel.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsMetadataFieldTypeModel]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsMetadataFieldTypeModel]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, MetadataFieldGetAllMetadataFieldsPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsMetadataFieldTypeModel]]:
    """Returns all metadata field types according to the provided filter and output parameters
