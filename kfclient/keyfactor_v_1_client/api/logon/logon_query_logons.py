...
from ...models.logon_query_logons_pq_sort_ascending import LogonQueryLogonsPqSortAscending
from ...models.models_ssh_logons_logon_query_response import ModelsSSHLogonsLogonQueryResponse
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, LogonQueryLogonsPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/SSH/Logons".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsSSHLogonsLogonQueryResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsSSHLogonsLogonQueryResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsSSHLogonsLogonQueryResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsSSHLogonsLogonQueryResponse]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, LogonQueryLogonsPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsSSHLogonsLogonQueryResponse]]:
    """Returns all Logons according to the provided filter parameters
