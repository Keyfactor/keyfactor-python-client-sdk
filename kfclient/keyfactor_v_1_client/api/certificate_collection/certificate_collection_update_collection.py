...
from ...models.keyfactor_api_models_certificate_collections_certificate_collection_update_request import (
...
def _get_kwargs(
    *,
    client: Client,
    form_data: KeyfactorApiModelsCertificateCollectionsCertificateCollectionUpdateRequest,
    json_body: KeyfactorApiModelsCertificateCollectionsCertificateCollectionUpdateRequest,
