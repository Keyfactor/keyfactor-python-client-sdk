...
from ...models.certificate_collection_get_collections_pq_sort_ascending import (
    CertificateCollectionGetCollectionsPqSortAscending,
)
from ...models.models_certificate_query import ModelsCertificateQuery
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, CertificateCollectionGetCollectionsPqSortAscending] = UNSET,
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsCertificateQuery]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsCertificateQuery.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsCertificateQuery]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsCertificateQuery]]:
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsCertificateQuery]]:
    """Returns all certificate collections
