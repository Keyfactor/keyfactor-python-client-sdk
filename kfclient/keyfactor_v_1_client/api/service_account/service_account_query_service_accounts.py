...
from ...models.service_account_query_service_accounts_pq_sort_ascending import (
    ServiceAccountQueryServiceAccountsPqSortAscending,
)
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, ServiceAccountQueryServiceAccountsPqSortAscending] = UNSET,
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsSSHServiceAccountsServiceAccountResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsSSHServiceAccountsServiceAccountResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsSSHServiceAccountsServiceAccountResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsSSHServiceAccountsServiceAccountResponse]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, ServiceAccountQueryServiceAccountsPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsSSHServiceAccountsServiceAccountResponse]]:
    """Returns all ServiceAccounts according to the provided filter parameters
