...
from ...models.key_rotation_alert_get_key_rotation_alerts_paged_query_sort_ascending import (
    KeyRotationAlertGetKeyRotationAlertsPagedQuerySortAscending,
)
from ...models.keyfactor_api_models_alerts_key_rotation_key_rotation_alert_definition_response import (
...
def _get_kwargs(
    *,
    ...
    paged_query_sort_ascending: Union[Unset, None, KeyRotationAlertGetKeyRotationAlertsPagedQuerySortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Alerts/KeyRotation".format(client.base_url)
...
) -> Optional[List[KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse.from_dict(
...
def _build_response(
    *, response: httpx.Response
) -> Response[List[KeyfactorApiModelsAlertsKeyRotationKeyRotationAlertDefinitionResponse]]:
    return Response(
