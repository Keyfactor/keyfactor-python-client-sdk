...
from ...models.agent_get_agents_pq_sort_ascending import AgentGetAgentsPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, AgentGetAgentsPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Agents".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[KeyfactorApiModelsOrchestratorsAgentResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = KeyfactorApiModelsOrchestratorsAgentResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[KeyfactorApiModelsOrchestratorsAgentResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[KeyfactorApiModelsOrchestratorsAgentResponse]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, AgentGetAgentsPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[KeyfactorApiModelsOrchestratorsAgentResponse]]:
    """Returns all agents according to the provided filter and output parameters
