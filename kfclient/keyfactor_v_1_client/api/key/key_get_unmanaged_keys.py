...
from ...models.key_get_unmanaged_keys_pq_sort_ascending import KeyGetUnmanagedKeysPqSortAscending
from ...models.models_ssh_keys_unmanaged_key_response import ModelsSSHKeysUnmanagedKeyResponse
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, KeyGetUnmanagedKeysPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/SSH/Keys/Unmanaged".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsSSHKeysUnmanagedKeyResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsSSHKeysUnmanagedKeyResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsSSHKeysUnmanagedKeyResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsSSHKeysUnmanagedKeyResponse]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, KeyGetUnmanagedKeysPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsSSHKeysUnmanagedKeyResponse]]:
    """Returns Unmanaged SSH keys
