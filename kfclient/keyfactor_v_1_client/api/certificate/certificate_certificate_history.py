...
from ...models.certificate_certificate_history_query_sort_ascending import (
    CertificateCertificateHistoryQuerySortAscending,
)
from ...models.models_pki_certificate_operation import ModelsPKICertificateOperation
...
def _get_kwargs(
    ...
    *,
    ...
    query_sort_ascending: Union[Unset, None, CertificateCertificateHistoryQuerySortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/Certificates/{id}/History".format(client.base_url, id=id)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsPKICertificateOperation]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsPKICertificateOperation.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsPKICertificateOperation]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsPKICertificateOperation]]:
...
def sync(
    ...
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsPKICertificateOperation]]:
    """Gets the history of operations on a certificate
