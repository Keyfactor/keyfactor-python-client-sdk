...
from ...models.server_query_servers_pq_sort_ascending import ServerQueryServersPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, ServerQueryServersPqSortAscending] = UNSET,
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsSSHServersServerResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsSSHServersServerResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsSSHServersServerResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsSSHServersServerResponse]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, ServerQueryServersPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsSSHServersServerResponse]]:
    """Returns all servers according to the provided filter parameters
