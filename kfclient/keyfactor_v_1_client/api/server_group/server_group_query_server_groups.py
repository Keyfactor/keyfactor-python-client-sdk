...
from ...models.server_group_query_server_groups_pq_sort_ascending import ServerGroupQueryServerGroupsPqSortAscending
...
def _get_kwargs(
    *,
    ...
    pq_sort_ascending: Union[Unset, None, ServerGroupQueryServerGroupsPqSortAscending] = UNSET,
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Dict[str, Any]:
    url = "{}/SSH/ServerGroups".format(client.base_url)
...
def _parse_response(*, response: httpx.Response) -> Optional[List[ModelsSSHServerGroupsServerGroupResponse]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ModelsSSHServerGroupsServerGroupResponse.from_dict(response_200_item_data)
...
def _build_response(*, response: httpx.Response) -> Response[List[ModelsSSHServerGroupsServerGroupResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Response[List[ModelsSSHServerGroupsServerGroupResponse]]:
    ...
    Args:
        ...
        pq_sort_ascending (Union[Unset, None, ServerGroupQueryServerGroupsPqSortAscending]):
...
def sync(
    *,
    ...
    x_keyfactor_api_version: Union[Unset, str] = "1",
    x_keyfactor_requested_with: str = "APIClient",
) -> Optional[List[ModelsSSHServerGroupsServerGroupResponse]]:
    """Returns all server groups according to the provided filter parameters
