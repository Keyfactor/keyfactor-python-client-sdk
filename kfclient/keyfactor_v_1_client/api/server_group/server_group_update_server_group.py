...
from ...models.models_ssh_server_groups_server_group_update_request import ModelsSSHServerGroupsServerGroupUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    form_data: ModelsSSHServerGroupsServerGroupUpdateRequest,
    json_body: ModelsSSHServerGroupsServerGroupUpdateRequest,
